			...
			<div class="conteudo">
				...
				<form action="" method="POST" enctype="multipart/form-data">
					<table border="0" style="width:100%;">
						<tr>
							<td>Judul</td>
							<td><input type="text" id="TPDF" name="judul"></td>
						</tr>
						<tr>
							<td>Tanggal Dibuat</td>
							<td><input type="date" id="TPDF" name="buat"></td>
						</tr>
						<tr>
							<td>File <i>(pdf)</i></td>
        ...
        if (isset($_POST['upload'])){
            ...
            if (in_array($tipe_file, array ('pdf','docx'))===true){
                if ($size < 11044070){
                    ...
                    $upload = mysqli_query($koneksi, "INSERT INTO `dokumen` (`id_dokumen`, `judul`, `tanggal_dibuat`, `tanggal_upload`) VALUES (NULL, '$judul', '$buat', '$tgl')");
                    if ($upload){
                        echo "<script>window.alert('Terima Kasih. Dokumen telah Terdata!'); window.location=('listdokumen.php');</script>";
                    }
                    else {
