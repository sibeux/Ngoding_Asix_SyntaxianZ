	...
	<div class="wrap">
        ...
        <?php
            if (isset($_POST["search"])){
                ...
                <div class="blog">
                    <div class="conteudo">
                        <h1>Semua Hasil Terkait <?php echo "<b><i>$_POST[cari]</i></b>"; ?></h1>
                        <div class="post-info">
                        ...
                        <table border=1>
                            ...
                            <?php
                                $data = mysqli_query($koneksi, "SELECT * FROM dokumen WHERE judul LIKE '%$_POST[cari]%'");
                                $nomer = 1;
                                while ($d = mysqli_fetch_object($data)){
                                    ...
                                    echo "<td>".$no++."</td>";
                                    echo "<td>$d->judul</td>";
                                    echo "<td>$d->tanggal_dibuat</td>";
                                    echo "<td>$d->tanggal_upload</td>";
                                    echo "<td><a target='_blank' href=view.php?id_dokumen=$d->id_dokumen>Lihat<a>";
                                    echo "<td><a target='_blank' href=download.php?id_dokumen=$d->id_dokumen>Unduh<a>";
                                    echo "<td><a href=edit.php?id_dokumen=$d->id_dokumen>Ubah<a>";
                                    echo "<td><a href=hapus.php?id_dokumen=$d->id_dokumen>Hapus<a>";
                                    echo "<tr>";
                                }
                            ?>
                        </table>
