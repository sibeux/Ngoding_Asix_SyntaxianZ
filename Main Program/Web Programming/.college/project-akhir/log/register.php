        ...
        <div class="login-content">
            <form>
                ...
                <div class="input-div one">
                    ...
                    <div class="div">
                        <h5>Nama Lengkap</h5>
                        <input type="text" class="input" name="nama" id="nama" required>
                    </div>
                </div>
                <div class="input-div one">
                    <div class="i">
                ...
                <div class="input-div pass">
                    ...
                    <div class="div">
                        <h5>Password</h5>
                        <input type="password" class="input" autocomplete="on" name="pass" id="pass" required>
                    </div>
                </div>
...
$(document).ready(function() {
    $("form").submit(function(event) {
        ...
        $.post("post/register.php?action=create&id=1", data, function(response) {
            swal("Akun berhasil didaftarkan", "Klik login untuk melanjutkan!", "success", {
                    button: "Login",
                })
                .then((value) => {
